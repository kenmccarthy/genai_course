#!/usr/bin/env python3
"""
Build a SCORM 1.2 package from the SETU AI Literacy course.
...
Output:
    dist/setu-ai-literacy-scorm-1.2.zip
"""
...
# ---- Package metadata -------------------------------------------------------
IDENTIFIER   = "SETU_AI_LITERACY_M1"
COURSE_TITLE = "AI Literacy — Understanding AI in Higher Education"
ORG_TITLE    = "SETU GenAI Programme — Module 1: AI Literacy"
VERSION      = "1.0"
LAUNCH       = "index.html"
OUTPUT_NAME  = "setu-ai-literacy-scorm-1.2.zip"
